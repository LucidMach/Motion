...
KNOWN_LOCATIONS = {
    'alan finkel building': (-37.9135, 145.1328),
    'the spot building': (-37.7997, 144.9602),
    'monash university': (-37.9105, 145.1347),
    'monash university clayton': (-37.9105, 145.1347),
    'richmond': (-37.8240, 144.9895),
    'richmond station': (-37.8240, 144.9895),
    'footscray': (-37.8010, 144.9004),
    'footscray station': (-37.8010, 144.9004),
    'flinders street': (-37.8180, 144.9671),
    'flinders street station': (-37.8180, 144.9671),
    'southern cross': (-37.8185, 144.9525),
    'southern cross station': (-37.8185, 144.9525),
    'melbourne central': (-37.8100, 144.9628),
    'melbourne central station': (-37.8100, 144.9628),
    'parliament': (-37.8115, 144.9730),
    'parliament station': (-37.8115, 144.9730),
