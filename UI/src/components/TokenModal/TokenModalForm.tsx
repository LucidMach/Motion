    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-2">
        ...
        <input
          ...
          autoComplete="off"
          spellCheck={false}
          className="w-full rounded-md border border-subtle bg-[rgba(5,7,13,0.8)] px-3.5 py-3 font-mono text-[0.82rem] text-primary outline-none transition-all focus:border-accent-cyan focus:shadow-[0_0_0_3px_rgba(56,189,248,0.2)]"
        />
