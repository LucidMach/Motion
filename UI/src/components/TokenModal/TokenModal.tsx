...
export default function TokenModal() {
  ...
  return (
    <div
      ...
      className={`fixed inset-0 z-100 flex items-center justify-center bg-[rgba(3,7,18,0.75)] backdrop-blur-sm transition-all duration-250 ${isOpen ? 'visible opacity-100' : 'invisible pointer-events-none opacity-0'
        }`}
    >
      <div className="flex w-[90%] max-w-120 animate-modal-in flex-col gap-5 rounded-lg border border-glow bg-surface-elevated p-6 shadow-[0_20px_50px_rgba(0,0,0,0.6),0_0_30px_rgba(56,189,248,0.15)]">
